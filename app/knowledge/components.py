...
class KnownComponent:
    ...
    fingerprint_patterns: List[str] = field(default_factory=list)  # 响应中用于识别的模式
    ...
    def extract_version(self, body: str, headers: Dict[str, str]) -> Optional[str]:
        """从响应中提取组件版本号。"""
...
class ComponentDatabase:
    ...
    def _init_builtin(self) -> None:
        ...
        nginx = KnownComponent(
            ...
            cves=[
                CVEEntry("CVE-2021-23017", "high", 7.7,
                         "nginx DNS 解析器堆缓冲区溢出",
                         "<1.20.1", "1.20.1"),
                CVEEntry("CVE-2019-20372", "high", 7.5,
                         "HTTP 请求走私导致拒绝服务",
                         "<1.17.7", "1.17.7"),
                CVEEntry("CVE-2018-16843", "medium", 5.3,
                         "HTTP/2 内存泄漏",
                         "<1.15.6", "1.15.6"),
            ],
        )
        ...
        apache = KnownComponent(
            ...
            cves=[
                CVEEntry("CVE-2021-41773", "high", 7.5,
                         "Apache 路径遍历和文件泄露",
                         "<2.4.50", "2.4.50"),
                CVEEntry("CVE-2021-42013", "high", 7.5,
                         "Apache 路径遍历（41773 补丁绕过）",
                         "<2.4.51", "2.4.51"),
                CVEEntry("CVE-2020-9484", "high", 7.5,
                         "Apache 反序列化 RCE",
                         "<2.4.43", "2.4.43"),
            ],
        )
        ...
        iis = KnownComponent(
            ...
            cves=[
                CVEEntry("CVE-2015-1635", "high", 7.3,
                         "IIS HTTP 协议栈 RCE",
                         "<6.0", "6.0"),
                CVEEntry("CVE-2015-8111", "medium", 4.3,
                         "IIS FTP 身份验证绕过",
                         "<7.0", "7.0"),
            ],
        )
        ...
        php = KnownComponent(
            ...
            cves=[
                CVEEntry("CVE-2021-21703", "high", 7.8,
                         "PHP-FPM 堆缓冲区溢出",
                         "<8.0.13", "8.0.13"),
                CVEEntry("CVE-2021-21708", "high", 7.8,
                         "PHP LDAP 堆缓冲区溢出",
                         "<8.0.15", "8.0.15"),
                CVEEntry("CVE-2024-4577", "critical", 9.8,
                         "PHP CGI 参数注入 RCE",
                         "<8.3.8", "8.3.8"),
            ],
        )
        ...
        django = KnownComponent(
            ...
            cves=[
                CVEEntry("CVE-2023-46695", "high", 7.5,
                         "Django DoS via IPv6",
                         "<4.2.7", "4.2.7"),
                CVEEntry("CVE-2023-41164", "medium", 5.3,
                         "Django django.utils.encoding.uri_to_iri",
                         "<4.2.5", "4.2.5"),
                CVEEntry("CVE-2023-36053", "high", 7.5,
        ...
        flask = KnownComponent(
            ...
            cves=[
                CVEEntry("CVE-2023-30861", "medium", 5.3,
                         "Flask Cookie 会话固定",
                         "<2.2.5", "2.2.5"),
            ],
        )
        ...
        express = KnownComponent(
            ...
            cves=[
                CVEEntry("CVE-2022-24999", "high", 7.5,
                         "Express qs 解析原型污染",
                         "<4.17.3", "4.17.3"),
            ],
        )
        ...
        spring_boot = KnownComponent(
            ...
            cves=[
                CVEEntry("CVE-2022-22965", "critical", 9.8,
                         "Spring4Shell RCE",
                         "<2.6.6", "2.6.6"),
                CVEEntry("CVE-2022-22963", "critical", 9.8,
                         "Spring Cloud Function SpEL RCE",
                         "<3.2.3", "3.2.3"),
                CVEEntry("CVE-2022-22950", "medium", 5.4,
        ...
        wordpress = KnownComponent(
            ...
            cves=[
                CVEEntry("CVE-2023-2745", "high", 7.5,
                         "WordPress 目录遍历",
                         "<6.2.1", "6.2.1"),
                CVEEntry("CVE-2022-21661", "high", 7.5,
                         "WP_Query SQL 注入",
                         "<5.8.3", "5.8.3"),
                CVEEntry("CVE-2021-39200", "medium", 5.3,
        ...
        joomla = KnownComponent(
            ...
            cves=[
                CVEEntry("CVE-2023-23752", "high", 7.5,
                         "Joomla 未授权信息泄露",
                         "<4.2.7", "4.2.7"),
                CVEEntry("CVE-2023-22602", "high", 7.5,
                         "Joomla SQL 注入",
                         "<4.2.6", "4.2.6"),
            ],
        )
        ...
        jquery = KnownComponent(
            ...
            cves=[
                CVEEntry("CVE-2020-11023", "medium", 5.3,
                         "jQuery XSS via htmlPrefilter",
                         "<3.5.0", "3.5.0"),
                CVEEntry("CVE-2015-9251", "medium", 5.3,
    ...
    def identify(self, body: str, headers: Dict[str, str]) -> List[Tuple[KnownComponent, Optional[str]]]:
        """从 HTTP 响应中识别组件。

        Returns:
            匹配的组件列表，每项包含组件和提取到的版本（可能为 None）
        """
        matched: List[Tuple[KnownComponent, Optional[str]]] = []
    ...
    def get_cves(self, component_name: str, version: Optional[str] = None) -> List[CVEEntry]:
        """查询组件的 CVE 列表。
    ...
    def get_component(self, name: str) -> Optional[KnownComponent]:
        """获取指定组件。"""
