...
class ServerExposureDetector(BaseVulnDetector):
    ...
    async def detect(self, context: ScanContext) -> list[Finding]:
        ...
        exposure_rules = {
            ...
            "x-aspnet-core-version": {
                "title": "ASP.NET Core 版本泄露",
                "parameter": "X-AspNet-Core-Version",
                "severity": "medium",
                "cwe": "CWE-200",
                "owasp": "A05 安全配置错误",
                "fix": "关闭 ASP.NET Core 版本响应头输出。",
            },
            "x-generator": {
...
class SensitiveEndpointDetector(BaseVulnDetector):
    ...
    async def detect(self, context: ScanContext) -> list[Finding]:
        ...
        candidates = [
            ...
            ("/actuator/info", "暴露 Spring Boot Actuator 信息端点", "medium", ['"app"', '"build"', '"git"'], 1, "CWE-200"),
            ("/actuator/metrics", "暴露 Spring Boot Actuator 指标目录", "medium", ['"names"', '"measurements"', '"availableTags"'], 1, "CWE-200"),
            ("/actuator/conditions", "暴露 Spring Boot Actuator 条件评估端点", "high", ['"positiveMatches"', '"negativeMatches"', '"exclusions"'], 1, "CWE-200"),
            ("/actuator/loggers", "暴露 Spring Boot Actuator 日志级别端点", "high", ['"configuredLevel"', '"effectiveLevel"', '"levels"'], 1, "CWE-200"),
            ("/actuator/caches", "暴露 Spring Boot Actuator 缓存端点", "medium", ['"cacheManagers"', '"caches"', '"target"'], 1, "CWE-200"),
            ("/actuator/scheduledtasks", "暴露 Spring Boot Actuator 定时任务端点", "medium", ['"cron"', '"fixedDelay"', '"fixedRate"'], 1, "CWE-200"),
            ("/actuator/health/liveness", "暴露 Spring Boot Actuator 存活探针端点", "low", ['"status":"UP"', '"liveness"'], 1, "CWE-200"),
            ("/actuator/health/readiness", "暴露 Spring Boot Actuator 就绪探针端点", "low", ['"status":"UP"', '"readiness"'], 1, "CWE-200"),
            ("/actuator/configprops", "暴露 Spring Boot Actuator 配置属性端点", "high", ['"contexts"', '"beans"', '"prefix"'], 2, "CWE-200"),
            ("/actuator/beans", "暴露 Spring Boot Actuator Beans 端点", "high", ['"contexts"', '"beans"', '"scope"'], 2, "CWE-200"),
            ("/actuator/mappings", "暴露 Spring Boot Actuator 路由映射端点", "high", ['"dispatcherServlets"', '"handlerMappings"', '"predicate"'], 2, "CWE-200"),
            ("/actuator/heapdump", "暴露 Spring Boot HeapDump 端点", "high", ["java heap dump", "heapdump", "class histogram"], 1, "CWE-200"),
            ...
            ("/v2/keys/", "暴露 etcd v2 Key API", "high", ["action", "node", "key", "dir"], 2, "CWE-200"),
            ("/v2/members", "暴露 etcd 成员信息", "high", ["members", "peerURLs", "clientURLs"], 2, "CWE-200"),
            ("/v2/stats/self", "暴露 etcd 自身状态", "medium", ["dbSize", "leaderInfo", "recvAppendRequestCnt"], 2, "CWE-200"),
            ...
            ("/api/v2/status", "暴露 Alertmanager 状态端点", "medium", ["alertmanager", "version", "cluster"], 2, "CWE-200"),
            ...
            ("/api/v2.0/registries", "暴露 Harbor 仓库注册信息", "high", ["harbor", "endpoint", "provider"], 2, "CWE-200"),
            ("/api/v2.0/labels", "暴露 Harbor 标签信息", "medium", ["harbor", "label_name", "scope"], 2, "CWE-200"),
            ("/api/v2.0/replication/policies", "暴露 Harbor 复制策略", "high", ["harbor", "dest_registry", "trigger_mode"], 2, "CWE-200"),
            ("/api/v2.0/projects", "暴露 Harbor 项目端点", "high", ["harbor", "project_id", "metadata"], 1, "CWE-200"),
            ("/api/v2.0/users/current", "暴露 Harbor 当前用户信息", "high", ["harbor", "username", "has_admin_role"], 2, "CWE-200"),
            ("/api/version", "暴露 Argo CD 版本信息", "medium", ["argocd", "version", "gitcommit"], 2, "CWE-200"),
            ("/api/v1/applications", "暴露 Argo CD 应用列表", "high", ["argocd", "metadata", "status"], 2, "CWE-200"),
            ("/api/v1/projects", "暴露 Argo CD 项目列表", "high", ["argocd", "clusterresourcewhitelist", "destinations"], 2, "CWE-200"),
            ("/api/v1/clusters", "暴露 Argo CD 集群列表", "high", ["argocd", "server", "name"], 2, "CWE-200"),
            ("/api/v1/repositories", "暴露 Argo CD 仓库列表", "high", ["argocd", "repoURL", "connectionState"], 2, "CWE-200"),
            ("/api/v1/session/userinfo", "暴露 Argo CD 当前会话信息", "medium", ["argocd", "email", "subject"], 2, "CWE-200"),
            ("/settings", "暴露 Argo CD 设置页面", "medium", ["argocd", "settings", "repository"], 2, "CWE-200"),
            ("/api/health", "暴露 Grafana 健康状态端点", "medium", ["database", "version", "commit"], 2, "CWE-200"),
            ("/api/search", "暴露 Grafana 搜索接口", "medium", ["dashboard", "title", "uri"], 2, "CWE-200"),
            ("/api/folders", "暴露 Grafana 文件夹接口", "medium", ["folder", "title", "uid"], 2, "CWE-200"),
            ("/api/datasources", "暴露 Grafana 数据源接口", "high", ["datasource", "type", "url"], 2, "CWE-200"),
            ("/api/org", "暴露 Grafana 组织信息", "medium", ["main org", "timezone", "id"], 2, "CWE-200"),
            ("/api/org/users", "暴露 Grafana 组织用户列表", "high", ["login", "email", "role"], 2, "CWE-200"),
            ("/api/org/users/lookup", "暴露 Grafana 组织用户查找接口", "medium", ["login", "email", "avatarurl"], 2, "CWE-200"),
            ("/api/user", "暴露 Grafana 当前用户信息", "medium", ["login", "email", "theme"], 2, "CWE-200"),
            ...
            ("/containers/json", "暴露 Docker 容器列表接口", "high", ['"image"', '"names"', '"state"', '"id"'], 2, "CWE-200"),
            ("/images/json", "暴露 Docker 镜像列表接口", "high", ['"repoTags"', '"size"', '"id"'], 2, "CWE-200"),
            ("/debug/pprof/", "暴露 Go pprof 调试端点", "high", ["profiles", "goroutine", "heap"], 1, "CWE-200"),
            ("/debug/vars", "暴露 Go expvar 调试端点", "high", ["cmdline", "memstats", "goroutines"], 1, "CWE-200"),
            ...
            ("/phpmyadmin", "暴露 phpMyAdmin 管理面板", "high", ["phpmyadmin", "server version", "login"], 1, "CWE-200"),
            ("/jenkins", "暴露 Jenkins 管理面板", "high", ["jenkins", "dashboard", "build history"], 1, "CWE-200"),
            ("/grafana", "暴露 Grafana 管理面板", "medium", ["grafana", "dashboard", "login"], 1, "CWE-200"),
            ("/api/status", "暴露 Kibana 状态端点", "medium", ["kibana", "overall", "version"], 2, "CWE-200"),
            ("/kibana", "暴露 Kibana 管理面板", "medium", ["kibana", "dashboard", "elastic"], 1, "CWE-200"),
            ("/manager/html", "暴露 Tomcat Manager 管理面板", "high", ["tomcat manager", "application manager", "deploy", "undeploy"], 1, "CWE-200"),
...
class BackupExposureDetector(BaseVulnDetector):
    ...
    async def detect(self, context: ScanContext) -> list[Finding]:
        ...
        candidates = [
            ...
            ("/database.sql.gz", "压缩数据库备份文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ("/backup.sql.bak", "数据库备份旧版本暴露", "high", ["create table", "insert into", "drop table", "mysqldump", "dump completed"], "CWE-200"),
            ("/dump.sql.bak", "数据库导出旧版本暴露", "high", ["create table", "insert into", "drop table", "mysqldump", "dump completed"], "CWE-200"),
            ("/backup.db.gz", "压缩数据库备份文件暴露", "high", ["sqlite", "create table", "schema", "pragma"], "CWE-200"),
            ("/database.db.gz", "压缩数据库文件暴露", "high", ["sqlite", "create table", "schema", "pragma"], "CWE-200"),
            ...
            ("/database.db.bak", "数据库旧备份文件暴露", "high", ["sqlite", "create table", "schema", "pragma"], "CWE-200"),
            ("/database.db", "数据库文件暴露", "high", ["sqlite", "create table", "schema", "pragma"], "CWE-200"),
            ("/backup.sql.zst", "压缩数据库备份文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ("/dump.sql.zst", "压缩数据库导出文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ...
            ("/export.zip", "压缩导出文件暴露", "medium", ["password", "secret", "token", "database", "backup"], "CWE-200"),
            ("/backup.tar.gz", "压缩备份文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ("/db.tar.gz", "压缩数据库文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ("/backup.tgz", "压缩备份文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ("/backup.tar.bz2", "压缩备份文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ("/dump.tar.bz2", "压缩导出文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ("/backup.tar.xz", "压缩备份文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ("/backup.sql.xz", "压缩数据库备份文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ("/db.tar.zst", "压缩数据库文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ("/backup.tar.zst", "压缩备份文件暴露", "high", ["mysql", "postgresql", "database", "dump", "backup"], "CWE-200"),
            ("/export.tar.zst", "压缩导出文件暴露", "medium", ["password", "secret", "token", "database", "backup"], "CWE-200"),
            ("/backup.7z", "压缩备份文件暴露", "high", ["password", "secret", "token", "database", "backup"], "CWE-200"),
            ("/dump.rar", "压缩导出文件暴露", "medium", ["password", "secret", "token", "database", "backup"], "CWE-200"),
            ...
            ("/.env.gz", "环境变量压缩备份暴露", "high", ["password", "secret", "token", "api_key", "jwt_secret"], "CWE-200"),
            ("/application.yml.bak", "应用配置备份暴露", "high", ["password:", "secret:", "token:", "api_key:", "spring:"], "CWE-200"),
            ("/application.yaml.bak", "应用配置备份暴露", "high", ["password:", "secret:", "token:", "api_key:", "spring:"], "CWE-200"),
            ("/config.yml.bak", "YAML 配置备份暴露", "high", ["password:", "secret:", "token:", "api_key:", "spring:"], "CWE-200"),
            ("/config.yaml.gz", "YAML 配置压缩备份暴露", "high", ["password:", "secret:", "token:", "api_key:", "spring:"], "CWE-200"),
