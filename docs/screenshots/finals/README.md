...
| 03 | `03-findings-detail.png` | 报告-详细问题 | 7 项详细漏洞（HSTS/CSP/X-Frame-Options/X-Content-Type-Options/Referrer-Policy/Permissions-Policy/Server 信息泄露）、P1-P3 优先级、OWASP 分类 | 产品文档的"扫描结果" |
| 04 | `04-findings-and-fix.png` | 报告-修复建议 | 8 种平台修复建议 tab（Nginx/Apache/Express/Flask/Spring Boot/Cloudflare/Node.js/Python）、可复制代码 | 产品文档的"修复建议" |
| 05 | `05-score-compare.png` | 报告-操作面板 | "用 AI 修复器生成补丁" / "一键应用修复" 操作按钮 | 产品文档的"工作流闭环" |
| 06 | `06-fix-generator.png` | 修复器-首页 | 粘贴配置文件、AI 智能检测、6 步使用流程 | 产品文档的"配置修复器模块" |
| 07 | `07-fix-diff.png` | 修复器-检测结果 | 4 高 + 2 中 + 2 低 严重度分布、修复点清单 | 产品文档的"AI 修复能力" |
| 08 | `08-fix-compare.png` | 修复器-代码对比 | 修复前/修复后 side-by-side 对比、Diff 高亮（绿+红） | 产品文档的"修复可视化" |
