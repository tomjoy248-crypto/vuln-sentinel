...
**在线体验**：提供可用的试用入口、本地部署方案与商业化计费入口，适合内测、演示和交付前复测。
...
- **离正式商业化还有多远**：主流程已可用，当前重点在继续压制误报、补充更多漏洞类型、完善交付口径，并加强真实站点回测。
...
| **标准包** | ￥69.90 | 120 credits，适合日常扫描与复测 |

| **专业包** | ￥299.00 | 600 credits，适合高频使用和团队交付 |
